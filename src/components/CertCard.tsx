...
export function CertCard({
  ...
  return (
    ...
    >
      <span
        aria-hidden="true"
        className="pointer-events-none absolute bottom-1 right-3 select-none font-mono text-6xl font-bold leading-none text-white/10"
      >
      ...
      <a
        ...
        className="flex flex-1 flex-col font-mono group text-sm uppercase tracking-[0.2em]
        ...
        <div className="relative z-10 flex flex-1 flex-col gap-4">
          ...
          <div className="mt-auto flex items-center justify-between border-t border-white/10 pt-4">
            {link ? (
              ...
              <span className="font-mono text-sm uppercase tracking-[0.2em] text-white/20">
                No record on file
              </span>
            )}
          </div>
